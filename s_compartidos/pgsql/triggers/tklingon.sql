...
DROP TRIGGER IF EXISTS tclas ON non_estructura;
...
BEGIN
    ...
    SELECT COUNT(*) INTO countnoestructuras FROM non_estructuras WHERE coda = new.coda;
    ...
    ELSIF countnonestructura = 1 THEN    
...
CREATE TRIGGER tclas BEFORE INSERT ON non_estructura FOR EACH ROW  EXECUTE FUNCTION ftclas();
